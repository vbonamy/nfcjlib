...
//    public  byte[] aesEncrypt( byte[] key,  byte[] data,  byte[] iv) throws Exception {
//        AesE
...
//    }
    ...
    public byte[] diversificationAES128(byte[] base_key, byte[] diversification_input, int diversification_length) throws Exception {
        ...
        // prepare the padding
        init(base_key);
        System.out.println(String.format("TEST K0=%s", DesfireUtils.byteArrayToHexString(cmac_subkey_0)));
        System.out.println(String.format("TEST K0=%s", DesfireUtils.byteArrayToHexString(cmac_subkey_1)));
        System.out.println(String.format("TEST K0=%s", DesfireUtils.byteArrayToHexString(cmac_subkey_2)));
        ...
        System.out.println("CMAC Input D=" + DesfireUtils.byteArrayToHexString(m));
        ...
        System.out.println("XOR the last 16 bytes with CMAC_SubKey2=" + DesfireUtils.byteArrayToHexString(m));
        int lsize = 32;
        ...
        System.out.println("Encryption using M=" + DesfireUtils.byteArrayToHexString(m));

        for (i = 0; i < 16; i++) {
            diversified_key[i] = result[16 + i];
        }

        System.out.println("Diversification key=" + DesfireUtils.byteArrayToHexString(diversified_key));
